...
# Import helpers from a shared utils file (see step 2)
...
class ExtractCog(commands.Cog):
    ...
    @app_commands.command(name="extract", description="Submit mission stats for official report!")
    async def extract(self, interaction: discord.Interaction, image: discord.Attachment):
